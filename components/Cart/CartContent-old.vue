<template>
    ...
    >
        <div v-show="isOpen"  class="fixed inset-0 overflow-hidden bg-gray-500 bg-opacity-75 transition-opacity z-50">
                    ...
                    >
                        <div v-show="isOpen" class="relative w-screen max-w-md">
                            <transition
                                ...
                                leave-to-class="opacity-0"
                            >
                                <div v-show="isOpen" class="absolute top-0 left-0 -ml-8 pt-4 pr-2 flex sm:-ml-10 sm:pr-4">
                                    <button @click="hideCartDetails" class="rounded-md text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <div class="h-full flex flex-col bg-white shadow-xl">
                                ...
                                <div class="pt-4 relative flex-1 px-4 sm:px-6 space-y-4 overflow-y-auto">
                                    <div v-if="cartContent.products.length > 0">
                                        <div v-for="item in cartContent.products" :key="item.id" class="flex justify-between items-center pb-4 border-b">
