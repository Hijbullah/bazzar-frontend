<template>
    <div class="mt-4">
        ...
        <div class="w-2/3 mx-auto border px-4 py-6">
            ...
            <div v-else>
                <div  v-if="addresses.length > 0" class="flex justify-between items-center px-3 py-2 border ">
                    <p>Abdul Mut</p>
                    <button>edit</button>
                </div> -->
...
export default {
    ...
    // async fetch() {
    //     this.addresses = await this.$axios.$get('/addresses/1');
    // },
    ...
    methods: {
        addNewAddress() {
            this.$axios.post('/addresses/1/create', this.address)
                .then(res => {
                    this.errors = null,
